...
<nav id="barraTop" class="navbar navbar-expand navbar-fixed-top col-12">
    ...
    <ul class="navbar-nav mr-auto col-12 d-flex justify-content-md-between">
      <li class="col-md-1 d-none d-md-flex" ><a  href="#"><i class="fab fa-facebook-f"></i></a></li>
      <li class="col-md-1 d-none d-md-flex"><a class="col-2" href="#"><i class="fab fa-twitter"></i></a></li>
      <li class="col-md-1 d-none d-md-flex"><a class="col-2" href="#"><i class="fab fa-instagram"></i></a></li>
      <li class="col-md-1 d-none d-md-flex"><a class="col-2" href="#"><i class="fab fa-deviantart" a></i></a></li>
   
      <?php 
            if(isset($_SESSION['validUser']) && $_SESSION['validUser'] == true) {  
             
              echo '<li class="col-md-4  d-md-flex">
