...
<footer id="footer" class="row d-flex bg-dark">
  ...
  <!--Columna de acceso a partes de la pagina-->
  <div class="col-md-4 col-12 justify-content-center columnaFooter">  
  ...
  <div class="col-md-4 justify-content-center columnaFooter">
  ...
  <!--Copyright-->
  <div id="rights" class="row col-md-4 col-12  columnaFooter">
