        ...
        <div class="card" >
          ...
          <div class="card" >
            <div class="control-group">
              ...
              <select id="country" name="country" class="input-xlarge"  class="form-control">
            ...
            <div class="control-group">
              <input id="address-line1" name="address-line1" type="text" placeholder="Calle, plaza, vía, etc." class="form-control">
              <div class="invalid-feedback">
                  Numero incorrecto
              </div>     
            </div>
            ...
            <div class="control-group">
             <input id="address-line2" name="address-line2" type="text" placeholder="Apartamento, suite, bloque, edificio, piso, etc." class="form-control">
              <div class="invalid-feedback">
                  Numero incorrecto
              </div>     
            </div>
            ...
            <div class="col-4 control-group">
              <input id="region" name="region" type="text" class="form-control" placeholder="Ciudad">
              <div class="invalid-feedback">
                  Numero incorrecto
              </div>  
            </div>
            <div class="col-4 control-group">
              <input id="city" name="city" type="text" class="form-control" placeholder="Estado/Provincia/Región">
              <div class="invalid-feedback">
                Numero incorrecto
              </div>       
            </div>
            <div class="col-4 control-group">
              <input id="city" name="city" type="text" class="form-control" placeholder="Codigo postal">
              <div class="invalid-feedback">
                Numero incorrecto
              </div>       
              </div>      
          ...
          <div class="card" >
          <input id="email" class="form-control" type="mail"  placeholder="Correo electrónico">
...
<script type="text/javascript">
  ...
  window.addEventListener('load', event_load => {
    ...
    function validUser($mail) {
      let ok = false;
      $emailExp = /[a-zA-Z0-9]@[a-zA-Z0-9-]{2,15}[.][a-zA-Z]{2,4}$/;
