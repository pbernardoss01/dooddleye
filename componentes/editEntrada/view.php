...
<div id="editEntrada" class="container">
    ...
    <div>
        <div  class="col-12">
            ...
            <div class="col-12">
                <div class="image-container">
                    <img id="imagenEntrada" src="" alt="Foto del producto">
                </div>
            </div>
        ...
        <div id="caracteristicasProducto" class="col-12">
            <input id="tituloEntrada" placeholder="Título de producto" type="text" class="col-12 form-control"></input>
